...
class LorawanMacHelper
{
  public:
    ...
    std::vector<uint16_t> SetSpreadingFactorsUp(NodeContainer endDevices,
                                                NodeContainer gateways,
                                                Ptr<LoraChannel> channel,
                                                bool enableRTX,
                                                uint8_t desiredSf);
    ...
    static std::vector<uint16_t> SetSpreadingFactorsStrategies(NodeContainer endDevices,
                                                               std::vector<uint16_t> sfQuantity,
                                                               uint32_t edge,
                                                               uint32_t edge2,
                                                               uint32_t nDev,
                                                               uint8_t mode);
    static std::vector<uint16_t> SetSpreadingFactorsProp(NodeContainer endDevices,
                                                         double prop1,
                                                         double prop2,
                                                         double rad);
     ...
     */
    static std::vector<uint16_t> SetSpreadingFactorsGivenDistribution(
